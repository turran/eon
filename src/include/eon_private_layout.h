...
typedef void (*Eon_Layout_Child_Hints_Get)(void *ref, void *child, Eon_Hints *hints);

/* the layout interface definition */
typedef void (*Eon_Layout_Hints_Get)(void *descriptor, void *data, Eon_Hints *hints);
...
static inline void eon_layout_hints_get(Eon_Layout *thiz, void *descriptor, void *data, Eon_Hints *hints)
{
	thiz->hints_get(descriptor, data, hints);
}
