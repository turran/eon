...
typedef void (*Eon_Layout_Child_Geometry_Set)(void *child, Enesim_Rectangle *g);
typedef void (*Eon_Layout_Child_Hints_Get)(void *child, Eon_Size *min, Eon_Size *max, Eon_Size *preferred);
...
typedef void (*Eon_Layout_Geometry_Set)(void *descriptor, void *data, Enesim_Rectangle *g);
...
static inline void eon_layout_geometry_set(Eon_Layout *thiz, void *descriptor, void *data, Enesim_Rectangle *g)
{
