...
#ifndef _EON_THEME_CONTROL_SCROLL_THUMB_AREA_H_
#define _EON_THEME_CONTROL_SCROLL_THUMB_AREA_H_

/**
 * @{
 */

typedef void (*Eon_Theme_Control_Scroll_Thumb_Area_Sizes_Get)(Eon_Theme_Widget *t, Eon_Size *min, Eon_Size *max);
typedef void (*Eon_Theme_Control_Scroll_Thumb_Area_Orientation_Set)(Eon_Theme_Widget *t, Eon_Orientation orientation);

typedef struct _Eon_Theme_Control_Scroll_Thumb_Area_Descriptor
{
	/* widget descriptor */
	...
	/* control_scroll_thumb_area descriptor */
...
} Eon_Theme_Control_Scroll_Thumb_Area_Descriptor;

EAPI Eon_Theme_Widget * eon_theme_control_scroll_thumb_area_new(Eon_Theme_Control_Scroll_Thumb_Area_Descriptor *descriptor, void *data);
