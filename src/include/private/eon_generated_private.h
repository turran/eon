#ifndef _EON_GENERATED_PRIVATE_H_
#define _EON_GENERATED_PRIVATE_H_

void eon_element_init(void);
void eon_widget_init(void);
void eon_layout_init(void);
...
void eon_progressbar_init(void);
void eon_entry_init(void);
void eon_canvas_init(void);
void eon_splitter_init(void);
