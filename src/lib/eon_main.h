...
EAPI extern Egueb_Dom_String *EON_NAME_ATTR_VALIGN;
EAPI extern Egueb_Dom_String *EON_NAME_ATTR_HALIGN;
...
EAPI extern Egueb_Dom_String *EON_NAME_ELEMENT_STACK;
