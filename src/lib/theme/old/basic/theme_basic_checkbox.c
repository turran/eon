 ...
 *                                   API                                      *
 *============================================================================*/
EAPI Eon_Theme_Widget * eon_theme_basic_checkbox_new(void)
{
	Eon_Theme_Widget *t;
	Eon_Basic_Checkbox *thiz;
	Enesim_Renderer *r;
 ...
 * FIXME: To be fixed
 */
EAPI void eon_theme_basic_checkbox_background_color_set(Eon_Theme_Widget *t, Enesim_Color background_color)
{
	Eon_Basic_Checkbox *thiz;
