 ...
 *                                 Global                                     *
 *============================================================================*/
void eon_theme_control_scroll_thumb_sizes_get(Eon_Theme_Widget *t, Eon_Size *min, Eon_Size *max)
{
	Eon_Theme_Control_Scroll_Thumb *thiz;
 ...
 *                                   API                                      *
 *============================================================================*/
Eon_Theme_Widget * eon_theme_control_scroll_thumb_new(Eon_Theme_Control_Scroll_Thumb_Descriptor *descriptor,
		void *data)
{
	Eon_Theme_Control_Scroll_Thumb *thiz;
...
void * eon_theme_control_scroll_thumb_data_get(Eon_Theme_Widget *t)
{
	Eon_Theme_Control_Scroll_Thumb *thiz;
