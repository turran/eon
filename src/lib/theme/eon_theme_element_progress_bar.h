...
#ifndef _EON_THEME_ELEMENT_PROGRESS_BAR_H_
#define _EON_THEME_ELEMENT_PROGRESS_BAR_H_

/**
 * @{
 */

#define EON_THEME_ELEMENT_PROGRESS_BAR_VERSION 0

typedef int (*Eon_Theme_Element_Progress_Bar_Descriptor_Thickness_Get_Cb)(void *data);

typedef struct _Eon_Theme_Element_Progress_Bar_Descriptor {
	...
	Eon_Theme_Element_Progress_Bar_Descriptor_Thickness_Get_Cb thickness_get;
} Eon_Theme_Element_Progress_Bar_Descriptor;
