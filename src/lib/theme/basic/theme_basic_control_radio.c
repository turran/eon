 ...
 *                                  Local                                     *
 *============================================================================*/
typedef struct _Basic_Control_Radio
{
	/* properties */
	Eina_Bool selected;
	/* private */
...
static void _radio_geometry_set(Enesim_Renderer *r, double x, double y, double w, double h)
{
		...
		Enesim_Error **error)
{
	...
	/* set the geometry */
	_readio_geometry_set(r, cs->x, cs->y, cs->width, cs->height);
	return EINA_TRUE;
}
