...
#ifndef _EON_DRAWER_RADIO_H_
#define _EON_DRAWER_RADIO_H_

/**
 * @{
 */

typedef void (*Eon_Drawer_Radio_Descriptor_Content_Set)(Eon_Drawer_Widget *w, void *data, Enesim_Renderer *r);
typedef void (*Eon_Drawer_Radio_Descriptor_Padding_Get)(Eon_Drawer_Widget *w, void *data, Eon_Box *padding);

typedef struct _Eon_Drawer_Radio_Descriptor {
	Eon_Drawer_Radio_Descriptor_Content_Set content_set;
	Eon_Drawer_Radio_Descriptor_Padding_Get padding_get;
