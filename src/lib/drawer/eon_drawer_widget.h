...
typedef Eina_Bool (*Eon_Drawer_Widget_Descriptor_Eon_Drawer_Process)(Eon_Drawer_Widget *w, void *data, Egueb_Dom_Node *n);
typedef void (*Eon_Drawer_Widget_Descriptor_Eon_Drawer_Populate)(Eon_Drawer_Widget *w, void *data, Egueb_Dom_Node *n);
