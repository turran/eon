 ...
 *                                  Local                                     *
 *============================================================================*/
typedef struct _Eon_Drawer_Attr_Primitive
{
	Eon_Drawer_Attr_Primitive_Set set;
	Eon_Drawer_Attr_Primitive_Get get;
	const Egueb_Dom_Value_Descriptor *descriptor;
	void *tmp_primitive;
} Eon_Drawer_Attr_Primitive;
/*----------------------------------------------------------------------------*
 *                        The exernal attr interface                           *
 *----------------------------------------------------------------------------*/
static void * _eon_drawer_attr_primitive_init(Egueb_Dom_Node *n)
{
	Eon_Drawer_Attr_Primitive *thiz;

	thiz = calloc(1, sizeof(Eon_Drawer_Attr_Primitive));
	return thiz;
}

static void _eon_drawer_attr_primitive_deinit(Egueb_Dom_Node *n, void *data)
{
	Eon_Drawer_Attr_Primitive *thiz = data;

	free(thiz->tmp_primitive);
	free(thiz);
}

static Eina_Bool _eon_drawer_attr_primitive_value_get(Egueb_Dom_Node *n, void *data,
...
static Eina_Bool _eon_drawer_attr_primitive_value_set(Egueb_Dom_Node *n, void *data,
		Egueb_Dom_Attr_Type type, Egueb_Dom_Value *value)
{
	Eon_Drawer_Attr_Primitive *thiz = data;
	Egueb_Dom_Node *owner;
...
static const Egueb_Dom_Value_Descriptor * _eon_drawer_attr_primitive_value_descriptor_get(
...
static Egueb_Dom_Attr_External_Descriptor _descriptor = {
	...
	/* value_get 		= */ _eon_drawer_attr_primitive_value_get,
	/* value_set	 	= */ _eon_drawer_attr_primitive_value_set,
};
/*============================================================================*
 *                                 Global                                     *
 *============================================================================*/
