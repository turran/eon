...
static void _strings_init(void)
{
	...
	EON_NAME_ATTR_VALIGN = egueb_dom_string_new_with_static_string("valign");
	EON_NAME_ATTR_HALIGN = egueb_dom_string_new_with_static_string("halign");
	...
	EON_NAME_ELEMENT_STACK = egueb_dom_string_new_with_static_string("stack");
