 ...
 *                                  Local                                     *
 *============================================================================*/
#define EON_ELEMENT_BUTTON_TOGGLE_DESCRIPTOR eon_element_button_toggle_descriptor_get()
#define EON_ELEMENT_BUTTON_TOGGLE(o) ENESIM_OBJECT_INSTANCE_CHECK(o,			\
		Eon_Element_Button_Toggle, EON_ELEMENT_BUTTON_TOGGLE_DESCRIPTOR)

typedef struct _Eon_Element_Button_Toggle
{
	Eon_Widget base;
	/* attributes */
	...
	Eina_Bool first_run;
} Eon_Element_Button_Toggle;

typedef struct _Eon_Element_Button_Toggle_Class
{
	Eon_Widget_Class base;
} Eon_Element_Button_Toggle_Class;

static void _eon_element_button_toggle_dispatch(
		Eon_Element_Button_Toggle *thiz, Eina_Bool activated)
{
...
static void _eon_element_button_toggle_click_cb(Egueb_Dom_Event *e,
		void *data)
{
	Eon_Element_Button_Toggle *thiz = data;
	Egueb_Dom_Event_Target *et;
	int activated = 0;
	...
	/* trigger the events */
	_eon_element_button_toggle_dispatch(thiz, !activated);
}
/*----------------------------------------------------------------------------*
 *                             Widget interface                               *
 *----------------------------------------------------------------------------*/
static void _eon_element_button_toggle_init(Eon_Widget *w)
{
	Eon_Element_Button_Toggle *thiz;
	Eon_Element *e;
	Egueb_Dom_Node *n;
	Egueb_Dom_Event_Target *et;

	thiz = EON_ELEMENT_BUTTON_TOGGLE(w);
	...
	egueb_dom_event_target_event_listener_add(et,
			...
			_eon_element_button_toggle_click_cb,
			EINA_FALSE, thiz);
	/* private */
	...
	egueb_dom_attr_string_list_append(e->theme_id, EGUEB_DOM_ATTR_TYPE_DEFAULT,
			egueb_dom_string_ref(EON_NAME_ELEMENT_BUTTON_TOGGLE));
}
/*----------------------------------------------------------------------------*
 *                           Renderable interface                             *
 *----------------------------------------------------------------------------*/
static Enesim_Renderer * _eon_element_button_toggle_renderer_get(Eon_Renderable *r)
{
	Eon_Element_Button_Toggle *thiz;
	Egueb_Dom_Node *theme_element;
	Enesim_Renderer *ren;

	thiz = EON_ELEMENT_BUTTON_TOGGLE(r);
...
static int _eon_element_button_toggle_size_hints_get(Eon_Renderable *r,
...
static Eina_Bool _eon_element_button_toggle_process(Eon_Renderable *r)
{
	Eon_Element_Button_Toggle *thiz;
	Eon_Widget *w;
 ...
 *                             Element interface                              *
 *----------------------------------------------------------------------------*/
static Egueb_Dom_String * _eon_element_button_toggle_tag_name_get(Eon_Element *e)
{
	return egueb_dom_string_ref(EON_NAME_ELEMENT_BUTTON_TOGGLE);
}

static Eina_Bool _eon_element_button_toggle_child_appendable(Eon_Element *e, Egueb_Dom_Node *child)
{
	Egueb_Dom_Node *n;
 ...
 *                              Object interface                              *
 *----------------------------------------------------------------------------*/
ENESIM_OBJECT_INSTANCE_BOILERPLATE(EON_WIDGET_DESCRIPTOR, Eon_Element_Button_Toggle,
		Eon_Element_Button_Toggle_Class, eon_element_button_toggle);

static void _eon_element_button_toggle_class_init(void *k)
{
	...
	klass->tag_name_get = _eon_element_button_toggle_tag_name_get;
	klass->child_appendable = _eon_element_button_toggle_child_appendable;

	r_klass = EON_RENDERABLE_CLASS(k);
	r_klass->renderer_get = _eon_element_button_toggle_renderer_get;
	r_klass->size_hints_get = _eon_element_button_toggle_size_hints_get;
	r_klass->process = _eon_element_button_toggle_process;

	w_klass = EON_WIDGET_CLASS(k);
	w_klass->init = _eon_element_button_toggle_init;
}

static void _eon_element_button_toggle_instance_init(void *o)
{
}

static void _eon_element_button_toggle_instance_deinit(void *o)
{
	Eon_Element_Button_Toggle *thiz;

	thiz = EON_ELEMENT_BUTTON_TOGGLE(o);
	/* attributes */
 ...
 *                                   API                                      *
 *============================================================================*/
EAPI Egueb_Dom_Node * eon_element_button_toggle_new(void)
{
	Egueb_Dom_Node *n;
	n = EON_ELEMENT_NEW(eon_element_button_toggle);
	return n;
}
